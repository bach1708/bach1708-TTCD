...
namespace K22_CNT2_NongVanBach.Controllers
{
    public class SAN_PHAMController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Image,Price,Quanity,Status")] SAN_PHAM sAN_PHAM)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Image,Price,Quanity,Status")] SAN_PHAM sAN_PHAM)
        {
            if (ModelState.IsValid)
            {
