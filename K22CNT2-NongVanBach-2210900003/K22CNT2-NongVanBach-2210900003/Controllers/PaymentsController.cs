...
namespace K22CNT2_NongVanBach_2210900003.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ma_giao_dich,ma_dat_ve,phuong_thuc_thanh_toan,so_tien,trang_thai_thanh_toan,ngay_thanh_toan")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ma_giao_dich,ma_dat_ve,phuong_thuc_thanh_toan,so_tien,trang_thai_thanh_toan,ngay_thanh_toan")] Payment payment)
        {
            if (ModelState.IsValid)
            {
